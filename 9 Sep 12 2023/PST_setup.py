...
def set_visuals(size, full, color, wintype, text, align, ht, wWidth, textcolor, radius, stimpath):
    win = visual.Window([600,400], fullscr=full, allowGUI = False, monitor = TEST_MONITOR, color = color, winType=wintype) #check window here
