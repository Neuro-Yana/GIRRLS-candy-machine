...
stimpath = stimpath = './Stims/'
#r"C:\Users\Yanko\OneDrive - University of Wyoming\Desktop - Copy\Lab\GRRL\TIT\Stims"

stim_rand = pd.DataFrame(columns=['stim','image'])
...
wintype='pyglet' 
win = visual.Window([600,400], fullscr = 'True', allowGUI = False, monitor = TEST_MONITOR, color = 'black', winType=wintype)
